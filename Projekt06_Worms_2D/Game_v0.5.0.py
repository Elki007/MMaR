"""
Stand:
- zuletzt wurde Wind eingefügt - anschauliches Beispiel siehe wind_map.py
...
class GameWindow(qw.QLabel):
    def __init__(self, parent):
        ...
        # wind settings
        self.wind_factor = 3  # max strength of wind in both directions (absolute value not bigger than wind_factor)
